...
export default function LocationsPage() {
  ...
  return (
    <motion.div
      ...
      className={cn("space-y-4", native ? "pb-4" : "h-[calc(100vh-7rem)] flex flex-col")}
    >
      <div>
      ...
      >
        <div className={cn("relative flex-1 min-w-0", native ? "w-full" : "max-w-md")}>
          <Search
            size={15}
      ...
      <div
        className={cn(
          ...
          native ? "grid-cols-1" : "grid-cols-1 lg:grid-cols-[320px_minmax(0,1fr)]",
        )}
      >
        ...
        <div className="bg-white border border-gray-200 rounded-xl overflow-hidden flex flex-col min-h-[360px]">
          ...
          <div className={cn("flex-1 min-h-[280px]", native && "h-[360px]")}>
            <LocationMap
              latitude={draftLat}
              longitude={draftLng}
              radiusMeters={draftRadius}
