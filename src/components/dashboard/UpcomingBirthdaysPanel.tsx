...
export function UpcomingBirthdaysPanel({
  ...
  return (
    <div
      className={cn(
        "bg-white border border-gray-200 rounded-xl p-5 flex flex-col h-full",
        className,
      )}
    >
      ...
      <p className="text-xs text-gray-400 mb-4">
        ...
        {todayCount > 0 ? (
          <span className="ml-2 inline-flex items-center gap-1 text-[10px] font-semibold px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-700">
            <Cake size={11} />
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  today && "bg-emerald-50 border border-emerald-100",
                )}
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-1.5 min-w-0">
                    {today ? (
                      <Cake size={14} className="text-emerald-600 shrink-0" />
                    ) : null}
                  ...
                  <div
                    className={cn(
                      "text-xs truncate",
                      today ? "text-emerald-600 font-medium" : "text-gray-400",
                    )}
                  >
                    {today
